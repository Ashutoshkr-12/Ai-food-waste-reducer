        ...
        {isScanning && (
          <div className="bg-white rounded-3xl p-8 text-center">
            <div className="relative w-64 h-64 mx-auto mb-6">
              <img 
                src="https://images.unsplash.com/photo-1606859191214-25806e8e2423?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmcmVzaCUyMHZlZ2V0YWJsZXMlMjByZWZyaWdlcmF0b3J8ZW58MXx8fHwxNzczMTU4NzAzfDA&ixlib=rb-4.1.0&q=80&w=1080"
                alt="Scanning"
