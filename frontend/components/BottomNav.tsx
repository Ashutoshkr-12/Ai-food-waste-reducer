...
import { Home,Refrigerator , BookOpen, Users, User } from 'lucide-react';
...
export default function BottomNav() {
  ...
  const navItems = [
    ...
    { path: '/my-fridge', icon: Refrigerator, label: 'Inventory' },
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-[#FFFCF8]/95 backdrop-blur-2xl border-t-2 border-gray-100 z-50 shadow-2xl">
      <div className="max-w-md mx-auto flex justify-around items-center px-2 h-20 ">
          ...
          return (
            ...
            >
              <div className="relative">
                ...
                {/* Icon container */}
                <div className={`flex flex-col items-center justify-center px-3 py-2 rounded-[1.25rem] ${
